...
(
	...
	, IdTipoIdentificacion INT NOT NULL 
		CONSTRAINT FK_Empleado_TipoIdentificacion FOREIGN KEY(IdTipoIdentificacion) REFERENCES dbo.TipoIndentificacion(IdTipoIdentificacion)
	...
	, TieneVehiculo  BIT NOT NULL
		CONSTRAINT DF_Empleado_TieneVehiculo DEFAULT(0)
